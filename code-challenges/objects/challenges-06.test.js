...
const hasChildrenValues = (arr, character) => {
  // Solution code here...
  let person = arr.find((obj) => obj.name === character);
  return Object.values(person)[2].length;
...
const hasChildrenEntries = (arr, character) => {
  // Solution code here...
  let objPerson = arr.find((obj) => obj.name === character);
  return Object.entries(objPerson)[2][1].length;
